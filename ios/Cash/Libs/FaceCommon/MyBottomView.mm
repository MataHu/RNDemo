...
- (void)creatBottomView {
    ...
    switch (self.countDownType) {
        case MGCountDownTypeRing: {
            countView = [[MGCountDownRingView alloc] initWithFrame:CGRectMake(self.frame.size.width - 80,
                                                                              self.topDistance * 0.7,
                                                                              60,
                                                                              60)];
        }
            break;
        case MGCountDownTypeText: {
            countView = [[MGCountDownTextView alloc] initWithFrame:CGRectMake(self.frame.size.width * 0.62,
                                                                              10,
                                                                              self.frame.size.width * 0.35,
                                                                              30)];
        }
            break;
        default:
